...
# Add the django tenants database router, so that the correct apps can be synced, depending on what’s being synced
# (shared or tenant).
...
# Define the models where the tenant & domain models are located.
# https://django-tenants.readthedocs.io/en/latest/install.html
