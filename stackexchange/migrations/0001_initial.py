    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text='If the user is an admin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='The post creation date')),
                ('last_edit', models.DateTimeField(auto_now=True, help_text='The post last edit date', null=True)),
