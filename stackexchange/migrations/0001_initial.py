# Generated by Django 4.2.9 on 2024-02-09 21:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='The parent site', null=True, on_delete=django.db.models.deletion.CASCADE, to='stackexchange.site')),
            ],
            options={
                'db_table': 'sites',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(help_text='The site', on_delete=django.db.models.deletion.CASCADE, to='stackexchange.site')),
                ('user', models.ForeignKey(blank=True, help_text='The user', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'site_users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_display_name', models.CharField(blank=True, help_text='The display name of the user that created this record', max_length=255, null=True)),
                ...
                ('user', models.ForeignKey(blank=True, help_text='The user that created this history record', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_history', to='stackexchange.siteuser')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='post',
            name='last_editor',
            field=models.ForeignKey(blank=True, help_text='The last editor of the post', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='last_edited_posts', to='stackexchange.siteuser'),
        ),
        migrations.AddField(
            model_name='post',
            name='owner',
            field=models.ForeignKey(blank=True, help_text='The owner of the post', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='stackexchange.siteuser'),
        ),
        migrations.AddField(
            model_name='post',
            name='question',
            field=models.ForeignKey(blank=True, help_text='The post question, if the post type is ANSWER', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='stackexchange.post'),
        ),
        migrations.CreateModel(
            name='UserBadge',
            fields=[
                ...
                ('user', models.ForeignKey(help_text='The site user', on_delete=django.db.models.deletion.CASCADE, related_name='badges', to='stackexchange.siteuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, help_text='The user for the post vote, if the post vote type is FAVORITE or BOUNTY_START', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='votes', to='stackexchange.siteuser')),
            ],
            options={
                'db_table': 'post_votes',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.ForeignKey(help_text='The post', on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='stackexchange.post')),
                ('tag', models.ForeignKey(help_text='The tag', on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='stackexchange.tag')),
            ],
            options={
                'db_table': 'post_tags',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, help_text='The user for the comment', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='stackexchange.siteuser')),
            ],
            options={
                'db_table': 'post_comments',
                'indexes': [models.Index(fields=['-creation_date', 'id'], name='post_commen_creatio_3cb624_idx'), models.Index(fields=['-score', 'id'], name='post_commen_score_26c330_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='post',
