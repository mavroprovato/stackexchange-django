# Generated by Django 3.2.12 on 2022-02-05 14:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge_class', models.SmallIntegerField(choices=[(1, 'gold'), (2, 'silver'), (3, 'bronze')], help_text='The badge class')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(choices=[(1, 'Question'), (2, 'Answer'), (3, 'Wiki'), (4, 'Tag Wiki Expert'), (6, 'Moderator Nomination'), (7, 'Wiki Placeholder'), (8, 'Privilege Wiki')], help_text='The post type')),
                ...
                ('accepted_answer', models.ForeignKey(blank=True, help_text='The accepted answer', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='accepted_answers', to='stackexchange.post')),
                ...
                ('parent', models.ForeignKey(blank=True, help_text='The parent post', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='stackexchange.post')),
            ],
            options={
                'db_table': 'posts',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.SmallIntegerField(choices=[(1, 'AcceptedByOriginator'), (2, 'UpMod'), (3, 'DownMod'), (4, 'Offensive'), (5, 'Favorite'), (6, 'Close'), (7, 'Reopen'), (8, 'Bounty Start'), (9, 'Bounty Close'), (10, 'Deletion'), (11, 'Un-deletion'), (12, 'Spam'), (13, 'Inform Moderator')], help_text='The post vote type')),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.BrinIndex(fields=['date_awarded'], name='user_badges_date_aw_fa6310_brin'),
        ),
        migrations.AddIndex(
            model_name='postvote',
            index=django.contrib.postgres.indexes.BrinIndex(fields=['creation_date'], name='post_votes_creatio_adca35_brin'),
        ),
        migrations.AddIndex(
            model_name='posthistory',
            index=django.contrib.postgres.indexes.BrinIndex(fields=['creation_date'], name='post_histor_creatio_ce20d5_brin'),
        ),
        migrations.AddIndex(
            model_name='post',
            index=django.contrib.postgres.indexes.BrinIndex(fields=['creation_date'], name='posts_creatio_dc5859_brin'),
        ),
        migrations.AddIndex(
            model_name='comment',
            index=django.contrib.postgres.indexes.BrinIndex(fields=['creation_date'], name='comments_creatio_d982f7_brin'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['-reputation'], name='users_reputat_efe40c_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=django.contrib.postgres.indexes.BrinIndex(fields=['creation_date'], name='users_creatio_027768_brin'),
        ),
    ]
