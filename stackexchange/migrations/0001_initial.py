# Generated by Django 5.2.4 on 2025-08-01 23:55

import django.contrib.postgres.indexes
import django.contrib.postgres.search
import django.db.models.deletion
import django.utils.timezone
import stackexchange.enums
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('to_tag_name', models.CharField(help_text='The to tag synonym name', max_length=255)),
                (
                    'creation_date',
                ...
                (
                    'from_tag',
                    models.ForeignKey(
                        help_text='The from synonym tag', on_delete=django.db.models.deletion.CASCADE,
                        related_name='from_synonym', to='stackexchange.tag')
                ),
                (
                    'to_tag',
                    models.ForeignKey(
                        blank=True, help_text='The to synonym tag', null=True,
                        on_delete=django.db.models.deletion.CASCADE, related_name='to_synonym', to='stackexchange.tag')
                ),
            ],
            options={
