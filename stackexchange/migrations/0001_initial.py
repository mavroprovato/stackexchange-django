# Generated by Django 3.2.12 on 2022-02-05 16:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.SmallIntegerField(choices=[(1, 'Accepted_by_originator'), (2, 'Up_mod'), (3, 'Down_mod'), (4, 'Offensive'), (5, 'Favorite'), (6, 'Close'), (7, 'Reopen'), (8, 'Bounty_start'), (9, 'Bounty_close'), (10, 'Deletion'), (11, 'Un_deletion'), (12, 'Spam'), (13, 'Inform_moderator')], help_text='The post vote type')),
