# Generated by Django 3.2 on 2021-04-13 20:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, help_text='The user for the vote', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_votes', to='stackexchange.user')),
            ],
            options={
                'db_table': 'post_votes',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, help_text='The user that created this history record', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_post_history', to='stackexchange.user')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='post',
            name='last_editor',
            field=models.ForeignKey(blank=True, help_text='The last editor of the post', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='last_editor_posts', to='stackexchange.user'),
        ),
        migrations.AddField(
            model_name='post',
            name='owner',
            field=models.ForeignKey(blank=True, help_text='The owner of the post', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='owner_posts', to='stackexchange.user'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, help_text='The user for the comment', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_comments', to='stackexchange.user')),
            ],
            options={
                'db_table': 'comments',
            },
