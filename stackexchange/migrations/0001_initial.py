...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'site',
                    models.ForeignKey(
                        help_text='The site', on_delete=django.db.models.deletion.CASCADE, to='sites.site'
                    )
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='siteuser',
            index=models.Index(fields=['site', 'unique_id'], name='site_users_site_id_0ef9fc_idx'),
        ),
        migrations.AddIndex(
            model_name='postvote',
