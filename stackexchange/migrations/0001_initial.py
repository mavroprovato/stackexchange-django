# Generated by Django 4.2.14 on 2024-08-02 00:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_license', models.CharField(choices=[('CC_BY_SA_2_5', 'Attribution-ShareAlike 2.5 Generic'), ('CC_BY_SA_3_0', 'Attribution-ShareAlike 3.0 Unported'), ('CC_BY_SA_4_0', 'Attribution-ShareAlike 4.0 International')], default='CC_BY_SA_4_0', help_text='The content license', max_length=40)),
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(help_text='The post tags', related_name='posts', through='stackexchange.PostTag', to='stackexchange.tag'),
        ),
        migrations.CreateModel(
            name='UserBadge',
            fields=[
