# Generated by Django 4.2.9 on 2024-02-03 05:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, help_text='The user email', max_length=255, unique=True)),
                ('display_name', models.CharField(help_text='The user display name', max_length=255)),
                ('website_url', models.URLField(blank=True, help_text='The user web site URL')),
                ('location', models.CharField(blank=True, help_text='The user location', max_length=255)),
                ('about', models.TextField(blank=True, help_text='The user about information')),
