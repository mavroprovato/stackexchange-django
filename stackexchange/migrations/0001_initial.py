# Generated by Django 3.2.12 on 2022-03-01 02:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql='''
            CREATE TRIGGER post_title_search_trigger BEFORE INSERT OR UPDATE
            ON posts FOR EACH ROW EXECUTE PROCEDURE
            tsvector_update_trigger(title_search, 'pg_catalog.english', title);
        ''',
            reverse_sql='''
            DROP TRIGGER post_title_search_trigger ON posts;
        ''',
        )
    ]
