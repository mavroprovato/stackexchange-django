...
class InfoSerializer(BaseSerializer):
    ...
    total_badges = fields.IntegerField(required=False, help_text="The total number of awarded badges")
    total_votes = fields.IntegerField(required=False, help_text="The total votes")
    ...
    total_accepted = fields.IntegerField(required=False, help_text="The total number of accepted answers")
