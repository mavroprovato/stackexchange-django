...
class Post(models.Model):
    ...
    created = models.DateTimeField(help_text="The post creation date", auto_now_add=True)
    last_edit = models.DateTimeField(help_text="The post last edit date", null=True, blank=True, auto_now=True)
    last_activity = models.DateTimeField(help_text="The post last activity date")
