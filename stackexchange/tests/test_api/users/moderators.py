...
class UserModeratorsTests(BaseUserTestCase):
    ...
    def test(self):
        ...
        response = self.client.get(reverse('user-moderators'))
        self.assert_items_equal(response)

    def test_sort_by_reputation(self):
        """Test the user list sorted by user reputation.
        """
        response = self.client.get(reverse('user-moderators'), data={'sort': 'reputation', 'order': 'asc'})
        self.assert_sorted(response, 'reputation')

        response = self.client.get(reverse('user-moderators'), data={'sort': 'reputation', 'order': 'desc'})
    ...
    def test_sort_by_creation(self):
        ...
        """
        response = self.client.get(reverse('user-moderators'), data={'sort': 'creation', 'order': 'asc'})
        self.assert_sorted(response, 'creation_date')

        response = self.client.get(reverse('user-moderators'), data={'sort': 'creation', 'order': 'desc'})
    ...
    def test_sort_by_display_name(self):
        ...
        """
        response = self.client.get(reverse('user-moderators'), data={'sort': 'name', 'order': 'asc'})
    ...
    def test_sort_by_modified(self):
        ...
        """
        response = self.client.get(reverse('user-moderators'), data={'sort': 'modified', 'order': 'asc'})
        self.assert_sorted(response, 'last_modified_date')

        response = self.client.get(reverse('user-moderators'), data={'sort': 'modified', 'order': 'desc'})
    ...
    def test_range_by_reputation(self):
        ...
        min_value = 10
        max_value = 1000
        response = self.client.get(reverse('user-moderators'), data={
    ...
    def test_in_name(self):
        ...
        query = 'oh'
        response = self.client.get(reverse('user-moderators'), data={'inname': query})
