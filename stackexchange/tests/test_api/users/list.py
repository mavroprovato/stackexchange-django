...
class UserListTests(BaseUserTestCase):
    ...
    def test_sort_by_reputation(self):
        ...
        """
        response = self.client.get(reverse('api-user-list'), data={'sort': 'reputation', 'order': 'asc'})
        self.assert_sorted(response, 'reputation')

        response = self.client.get(reverse('api-user-list'), data={'sort': 'reputation', 'order': 'desc'})
    ...
    def test_sort_by_creation(self):
        ...
        """
        response = self.client.get(reverse('api-user-list'), data={'sort': 'creation', 'order': 'asc'})
        self.assert_sorted(response, 'creation_date')

        response = self.client.get(reverse('api-user-list'), data={'sort': 'creation', 'order': 'desc'})
    ...
    def test_sort_by_display_name(self):
        ...
        """
        response = self.client.get(reverse('api-user-list'), data={'sort': 'name', 'order': 'asc'})
        self.assert_sorted(response, 'display_name')

        response = self.client.get(reverse('api-user-list'), data={'sort': 'name', 'order': 'desc'})
    ...
    def test_sort_by_modified(self):
        ...
        """
        response = self.client.get(reverse('api-user-list'), data={'sort': 'modified', 'order': 'asc'})
        self.assert_sorted(response, 'last_modified_date')

        response = self.client.get(reverse('api-user-list'), data={'sort': 'modified', 'order': 'desc'})
