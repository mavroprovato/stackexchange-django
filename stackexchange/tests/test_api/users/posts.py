...
from ..posts.base import BasePostTestCase


class UserPostTests(BasePostTestCase):
    """Users view set posts tests
    """
    @classmethod
    def setUpTestData(cls):
        ...
        for site_user in site_users:
            factories.PostFactory.create_batch(size=2, owner=site_user)
    ...
    def test_sort_by_activity(self):
        """Test the posts list endpoint sorted by activity date.
        """
        users = random.sample(list(models.User.objects.all()), 3)
