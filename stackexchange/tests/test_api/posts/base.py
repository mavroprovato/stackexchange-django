...
class BasePostTestCase(BaseTestCase):
    ...
    def assert_items_equal(self, response, model_class: typing.ClassVar = models.Post,
                           obj_filter: typing.Union[str, dict] = 'post_id', multiple: bool = False,
...
class BasePostRevisionTestCase(BaseTestCase):
    ...
    """
    def assert_items_equal(self, response, model_class: typing.ClassVar = models.PostHistory,
                           obj_filter: typing.Union[str, dict] = None, multiple: bool = True, attributes: dict = None):
        """Assert that the items returned by the response are the same as the database items.
        """
